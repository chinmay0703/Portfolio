                    ...
                    <div className="row">
                            ...
                            <div id="carouselExampleControls1" className="carousel slide my-1" data-bs-ride="carousel">
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src="../portfolio-images/1.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/2.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/3.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/4.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/5.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                </div>
                        ...
                        <div className="col-md-4 text-center my-2">
                            ...
                            <div id="carouselExampleControls2" className="carousel slide my-1" data-bs-ride="carousel">
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src="../portfolio-images/m-01.png" className="d-block w-100"  height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/m-02.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/m-03.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                </div>
                        ...
                        <div className="col-md-4 text-center my-2">
                            ...
                            <div id="carouselExampleControls3" className="carousel slide my-1" data-bs-ride="carousel">
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src="../portfolio-images/11.png" className="d-block w-100 " height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/12.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/13.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/14.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                </div>
                        ...
                        <div className="col-md-4 text-center my-2">
                            ...
                            <div id="carouselExampleControls4" className="carousel slide my-1" data-bs-ride="carousel">
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src="../portfolio-images/21.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/22.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
                                    <div className="carousel-item">
                                        <img src="../portfolio-images/23.png" className="d-block w-100" height="225" alt="..." />
                                    </div>
