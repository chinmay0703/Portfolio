...
function Sidebar() {
    return (
        <Fragment>
            ...
            <div className="col-auto col-md-2 col-xl-1 px-sm-1 px-0 bg-dark slide-in-left">
                <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <Link to="/" className="d-flex align-items-center pb-1 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span className="fs-5 d-none d-sm-inline ff-jost  my-4">Chinmay</span>
                    </Link>
                    <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li className="nav-item">
                            <NavLink to="/mywork" className="nav-link align-middle px-0 text-white">
                                <MdOutlineDashboard className='fs-5' /> <span className="ms-1 d-none d-sm-inline ">Work</span>
                            </NavLink>
                        </li>
                        {/* <li className="nav-item">
                            <NavLink to="/resume" className="nav-link align-middle px-0 text-white">
                                <AiOutlineUnorderedList className='fs-5'/> <span className=" d-none d-sm-inline ">Resume</span>
                            </NavLink>
                        </li> */}
                    </ul>
                    <hr />
                    <div className="dropdown pb-4 dropup">
                        ...
                        <li><a className="dropdown-item text-black" href="tel:+917620846379"><MdPhone className='fs-5' /> Call Me</a></li>
                             <li> <hr className="dropdown-divider" /> </li>
                            <li><a className="dropdown-item text-black" href="https://www.linkedin.com/in/chinmay-vyawahare-0055b81b7/" target="/blank"><AiFillLinkedin className='fs-5' /> LinkedIn</a></li>
                            {/* <li> <hr className="dropdown-divider"/> </li>
                            ...
                            <li> <hr className="dropdown-divider" /> </li>
                            <li><a className="dropdown-item text-black" href="https://github.com/chinmay0703" target="/blank"><AiFillGithub className='fs-5' /> Github</a></li>
                            {/* <li> <hr className="dropdown-divider"/> </li>
